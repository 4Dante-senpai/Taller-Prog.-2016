...
begin
  ...
  if ( a <> nil ) then begin
     if (a^.HI = nil) then
        ...
        m:= a^.dato    //si encuentra el minimo lo iguala
        else begin
  ...
  if ( a <> nil ) then begin
     if (a^.HD = nil) then
        ...
        m:= a^.dato    //si encuentra el minimo lo iguala
              ...
              a:= a^.HD;   //si el dato que busco es menor se la a la izq
              verMax(a,m);
              end;
  end
  else
...
begin
 ...
 if(m = -1) then
      ...
      writeln ('El elemento minimo del arbol es: ', m);
 verMax(ar, m);             //REUTILIZA LA VARIABLE M para ahorrar memoria
 if(m = -1) then
      writeln('El arbol esta vacio.')
      else
      writeln ('El elemento maximo del arbol es: ', m);
 readln;
end.
