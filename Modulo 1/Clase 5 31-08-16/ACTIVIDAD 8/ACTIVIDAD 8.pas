...
Var
 ...
 l: lista; ar:arbol; min, max: integer;
...
begin
 ...
 writeln (' ');
 writeln (' ');
 writeln('Ingrese el valor minimo del rango a buscar: ');
 readln(min);
 writeln('Ingrese el valor maximo del rango a buscar: ');
 readln(max);

 writeln (' ');
 writeln ('LOS VALORES COMPRENDIDOS ENTRE ',min,' Y ',max,' SON: ');
 verValoresEnRango(ar, min, max);
 readln();
end.
